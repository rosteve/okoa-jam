...
public class MapControlsLayer extends OsmandMapLayer {
    ...
    private static MapActivity mapActivity2;
    ...
    //TODO removed control.add for compass and configure map below commented .. remove visible invisible in xml of map layer button
    private void initTopControls() {
        ...
        View jam = mapActivity.findViewById(R.id.map_jam);
        jamhud = createHudButton((ImageView) jam, R.drawable.jam).setIconColorId(0).
                setBg(R.drawable.btn_inset_circle_trans, R.drawable.btn_inset_circle_night);
        compassHud.jam = true;
        controls.add(jamhud);
        jam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                net.osmand.Location lastKnownLocation = locationProvider.getLastKnownLocation();
                        /*LatLon loc2 = new LatLon(-1.2848, 36.81652);

                        AvoidSpecificRoads.findRoadJam(mapActivity, loc2);
*/
                if (lastKnownLocation == null) {
                    app.showToastMessage(R.string.unknown_location_jam);
                } else {
                    LatLon loc = new LatLon(lastKnownLocation.getLatitude(), lastKnownLocation.getLongitude());
//                    LatLon loc = new LatLon(-1.2848, 36.81652);

                    AvoidSpecificRoads.findRoadJam(mapActivity, loc);
                }
    ...
    public static void jam(LatLon lat){

        AvoidSpecificRoads.findRoadJam(mapActivity2, lat);
    }
...
//		layersHud.updateVisibility(!dialogOpened); TODO removed configure map button
