...
//TODO disabled configure screen
        ...
        optionsMenuHelper.item(R.string.reroute).iconColor(R.drawable.ic_action_gdirections_dark)
                .listen(new OnContextMenuClick() {
                    @Override
                    public boolean onContextMenuClick(ArrayAdapter<?> adapter, int itemId, int pos, boolean isChecked) {
                        /*if (!routingHelper.isFollowingMode() && !routingHelper.isRoutePlanningMode()) {
...
//TODO disabled the plugins options
...
//		TODO Disabled the help part of it
